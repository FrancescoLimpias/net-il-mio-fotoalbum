...
{
    /// <inheritdoc />
    public partial class Refactor003 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prioritary = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryPhoto", x => new { x.CategoriesCategoryId, x.PhotosPhotoId });
                    table.ForeignKey(
                        name: "FK_CategoryPhoto_Categories_CategoriesCategoryId",
                        column: x => x.CategoriesCategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryPhoto_Photos_PhotosPhotoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryPhoto_PhotosPhotoId",
                table: "CategoryPhoto",
